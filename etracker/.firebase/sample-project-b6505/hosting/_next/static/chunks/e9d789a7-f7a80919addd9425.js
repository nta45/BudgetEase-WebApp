"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[863],{4992:function(e,t,i){i.d(t,{o:function(){return t8}});var r,n=i(8885),s=i(3943),a=i(9053),o=i(1735),l=i(2680);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e4(e,t,i=!1){if((0,n.rh)(e.app))return Promise.reject(g(e));let r="signIn",s=await e1(e,r,t),a=await eQ._fromIdTokenResponse(e,r,s);return i||await e._updateCurrentUser(a.user),a}new WeakMap;let e9="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
